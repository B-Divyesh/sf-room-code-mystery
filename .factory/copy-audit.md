...
| Sentence | Words | Result |
| --- | ---: | --- |
| Each friend opens a numbered notebook on their own phone. | 10 | Pass |
...
| --- | ---: | --- |
| Demo — sample data, nothing is saved | 7 | Required demo-contract wording |
...
“Solve a three-round browser mystery with 4–8 friends and one shared room code.” 82 characters. It starts with a verb and stays below 120 characters.
